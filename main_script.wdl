...
workflow MAIN_WORKFLOW {
    ...
    File dummy_text_file_path = "gs://fc-d8650e80-227f-42d3-aacb-083f9da586cc/data/2024-09-10/space_ranger_dummy_files/dummy_text_file.txt"
    ...
    call SPACE_RANGER.space_ranger {
        ...
        input:
            ...
            fastq_read1_file_path = if defined(fastq_read1_file_path) then select_first([fastq_read1_file_path]) else dummy_text_file_path,
            fastq_read2_file_path = if defined(fastq_read2_file_path) then select_first([fastq_read2_file_path]) else dummy_text_file_path,
            fastq_reads_compressed_directory_path = if defined(fastq_reads_compressed_directory_path) then select_first([fastq_reads_compressed_directory_path]) else dummy_text_file_path,
            ...
            dummy_text_file_path = dummy_text_file_path
    }
}