...
task space_ranger {
    ...
    command <<<
        ...
        sliced_cytassist_image_path=("${cytassist_image_path[@]:${start_index}:${end_index}}")
        sliced_he_image_path=("${he_image_path[@]:${start_index}:${end_index}}")
        sliced_probe_set_file_path=("${probe_set_file_path[@]:${start_index}:${end_index}}")
        ...
        echo "Fastq start index: $fastq_start_index"
        
        sliced_fastq_file_path=("${fastq_file_path[@]:${fastq_start_index}:${fastq_end_index}}")

        echo "Sliced fastq_file_path: ${sliced_fastq_file_path[@]}"

        sliced_bam_file_save=("${bam_file_save[@]:${start_index}:${end_index}}")
        sliced_prefix_list_of_fastqs=("${prefix_list_of_fastqs[@]:${start_index}:${end_index}}")
        ...
        for ((i=0; i<num_files; i++)); do
            ...
            echo "Sliced fastq file path pair for iteration $i: ${sliced_fastq_file_path_pair[@]}"
            ...
            echo "Unzipping transcriptome file..."
            ...
            echo "Renaming output files for iteration $i..."
